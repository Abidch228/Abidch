...
─────────────────────────  
  ...
  \033[1;91m:》》》\033[1;93m+923124271911\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-MianAbid-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................Abid Ch......................
\033[1;93m╔═╦═╗╔══╗╔══╗╔═╦╗
\033[1;93m║║║║║╚║║╝║╔╗║║║║║
\033[1;93m║║║║║╔║║╗║╠╣║║║║║
...
jalan('              \033[1;96m....................HumiKhan.....................:')
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin MianAbid\033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "MianAbid"
CorrectPassword = "Humikhan"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as  MIAN ABID" + username #Dev:Mian_Abid
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	print "  \033[1;93m«---•◈•---Developed By Mian---•◈•---»" #Dev:love_hacker
